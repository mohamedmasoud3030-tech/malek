...
| `AppPermission` capabilities | 62 | **61** (now **60**) | count of `appPermissions` array in `features/auth/permissions.ts`; dropped to 60 when `settings.manage` was retired by `20260904000001_authoritative_permission_catalog_parity.sql` |
