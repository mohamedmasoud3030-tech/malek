...
|---|---|---|
| Migrations | `supabase/migrations/*.sql` | 242 files, including fail-closed live-drift reconciliation |
...
Replaying all 242 migrations into an empty database produces:
...
| Migration chain, clean DB | 242/242 applied, 0 failures |
