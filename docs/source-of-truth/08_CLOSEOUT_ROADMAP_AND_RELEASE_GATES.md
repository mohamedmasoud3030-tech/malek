...
- Tax posting blocks a missing effective profile and snapshots configured treatment/code/rate/basis/amount; credit and collection reuse the original snapshot rather than a later profile.
- VOID/credit/refund/termination paths preserve history and reconcile subledger/GL/report totals; 2000 uses append-only `owner_funds_events` for RC1 forward events.
...
| G4 — Posting and reversal | included-scope owner-agency event/retry/reversal tests | PARTIAL: corrected OWNER/OFFICE invoice, collection, profile-lineage credit/reversal, governed VOID and period matrix are repository-proven; MASTER_LEASE is excluded; live/pilot proof pending |
| G5 — GL/subledger reconciliation | 1201/2000/1300/2200/2300 and included controls tie within 0.001 | PARTIAL: RC1 synthetic path proves all five controls at 0.000; 1111/1120 tie to posted payment channel in the synthetic fixture, while real bank-statement match/live cycle proof remains pending |
