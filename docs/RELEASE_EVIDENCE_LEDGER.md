...
| Product/accounting decision gates | Product decided | Product decisions are recorded in `docs/decisions/0001-product-accounting-policies.md` and the canonical pack `docs/source-of-truth/08_CLOSEOUT_ROADMAP_AND_RELEASE_GATES.md`; implementation evidence remains required | Decision records plus implementation/evidence links for each affected workflow |
