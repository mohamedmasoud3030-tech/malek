...
- 🔶 **متبقٍ حوكمي**: CI على الـPR ثم دمج squash بعد موافقة المستخدم فقط. P2: تشديد حارس التداخل الجزئي للفترات + مكافحة ازدواج الأتعاب عبر الفترات + بنية دليل الحسابات لكل شركة.
