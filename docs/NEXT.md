...
**Single-office launch: GO.** لا تبدأ أعمال multi-office أو النسخ الاحتياطي أو أي مرحلة جديدة ضمن هذا الإطلاق.
...
- اكتملت بوابات الإطلاق على SHA واحد مع فحص يدوي غير متلف للرابط المنشور.
- `Leaked Password Protection` غير متاحة على خطة Supabase المجانية وليست مانعًا
  لإطلاق المكتب الأول.
