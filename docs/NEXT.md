...
**Single-office pilot: GO تقني، مع HOLD تشغيلي قصير قبل تسليم حسابات حقيقية.** آخر إصدار تطبيق هو `4c354f34` من PR #1299: يتضمن مانع desktop/RTL المغلق في #1292، الأرقام اللاتينية من #1298، وخريطة تنقل وسير تأسيس منظمة للمكتب الواحد. نشر Vercel Production للإصدار `READY` والرابط الرسمي `/login` يعيد `200`.

### ما تم إثباته في 2026-07-27

- Browser Readiness run `30227200393`: **243 ناجح / 204 متجاوز مقصود / 0 فشل** عبر desktop/tablet/mobile.
- CI `30227200374` وSonar `30227200359` وRelease Blocker `30227200394`: كلها ناجحة على head واحد `7dde0036`.
