-- Keep the dashboard RPC compatible with historical production, where
-- contracts.end_date is text rather than date. Invalid legacy values are
-- excluded from the expiring-contract count instead of crashing the RPC.
