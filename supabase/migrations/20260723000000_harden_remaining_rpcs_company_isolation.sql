...
-- ── 7. Re-define trigger functions with universal c.id::text comparisons ──
...
-- ── 8. Re-assert and Harden Grants for all 31 isolated functions ────────────

-- Hardening execution grants for multi-tenant isolation
revoke execute on function public.approve_owner_settlement_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.approve_owner_settlement_atomic(jsonb) to authenticated;
revoke execute on function public.cancel_owner_settlement_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.cancel_owner_settlement_atomic(jsonb) to authenticated;
revoke execute on function public.create_contract_atomic(text, uuid, uuid, uuid, date, date, numeric, text, uuid, text, text, text, text) from public, anon, authenticated;
...
revoke execute on function public.create_deposit_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.create_deposit_atomic(jsonb) to authenticated;
revoke execute on function public.create_expense_with_journal_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.create_expense_with_journal_atomic(jsonb) to authenticated;
revoke execute on function public.create_owner_agreement_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.create_owner_agreement_atomic(jsonb) to authenticated;
revoke execute on function public.create_owner_settlement_draft_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.create_owner_settlement_draft_atomic(jsonb) to authenticated;
revoke execute on function public.create_property_with_agreement(text, text, text, uuid, text, text, numeric, date, date, text, numeric, numeric, text, text) from public, anon, authenticated;
grant execute on function public.create_property_with_agreement(text, text, text, uuid, text, text, numeric, date, date, text, numeric, numeric, text, text) to authenticated;
revoke execute on function public.deduct_deposit_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.deduct_deposit_atomic(jsonb) to authenticated;
revoke execute on function public.execute_automation_rule(text) from public, anon, authenticated;
...
revoke execute on function public.pay_owner_settlement_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.pay_owner_settlement_atomic(jsonb) to authenticated;
...
revoke execute on function public.process_bank_reconciliation_match_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.process_bank_reconciliation_match_atomic(jsonb) to authenticated;
revoke execute on function public.record_invoice_payment_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.record_invoice_payment_atomic(jsonb) to authenticated;
revoke execute on function public.refund_deposit_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.refund_deposit_atomic(jsonb) to authenticated;
revoke execute on function public.renew_contract_atomic(text, jsonb) from public, anon, authenticated;
grant execute on function public.renew_contract_atomic(text, jsonb) to authenticated;
revoke execute on function public.soft_delete_contract_atomic(text) from public, anon, authenticated;
grant execute on function public.soft_delete_contract_atomic(text) to authenticated;
revoke execute on function public.terminate_contract_atomic(text, text) from public, anon, authenticated;
grant execute on function public.terminate_contract_atomic(text, text) to authenticated;
revoke execute on function public.update_contract_atomic(text, text, uuid, uuid, uuid, date, date, numeric, text, uuid, text, text, text, text) from public, anon, authenticated;
...
revoke execute on function public.update_expense_with_journal_atomic(jsonb) from public, anon, authenticated;
grant execute on function public.update_expense_with_journal_atomic(jsonb) to authenticated;
revoke execute on function public.update_owner_agreement_atomic(uuid, jsonb) from public, anon, authenticated;
grant execute on function public.update_owner_agreement_atomic(uuid, jsonb) to authenticated;
