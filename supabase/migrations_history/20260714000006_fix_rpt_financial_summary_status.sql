-- Migration: Fix rpt_financial_summary VOID/CANCELLED filters and date compatibility.
-- Supports both date-backed clean schemas and historical text-backed date columns.
