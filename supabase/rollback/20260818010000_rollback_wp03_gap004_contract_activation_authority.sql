...
-- 20260818010000_wp03_gap004_contract_activation_authority.sql.
-- Restores the exact pre-change create_contract_atomic /
-- update_contract_atomic definitions. Production remains forward-only; use a
