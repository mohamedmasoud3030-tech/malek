-- =============================================================================
-- FA-003 rollback — owner-settlement input reservation
-- =============================================================================
-- Reverts 20260804000000/0001/0002: drops the reservation tables, helper /
-- diagnostic / backfill functions and composite indexes, then restores the four
-- lifecycle RPCs to their exact pre-FA-003 bodies (from main@130269e6).
-- Forward direction is the default; this file exists only for emergency revert.
-- =============================================================================

begin;

drop table if exists public.owner_settlement_payment_links;
drop table if exists public.owner_settlement_expense_links;

drop function if exists public.enforce_owner_settlement_link_company_consistency();
...
drop function if exists public.diagnose_owner_settlement_duplication();
...
drop index if exists public.owner_settlements_id_company_uidx;
drop index if exists public.payments_id_company_uidx;
drop index if exists public.expenses_id_company_uidx;
