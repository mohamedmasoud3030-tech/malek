...
-- Rollback for: 20260807160000_s02_bank_csv_import_server_guards.sql
-- ============================================================================
-- Restores the immediately previous import_bank_statement_batch_atomic(jsonb)
-- definition from 20260805120000_s02_bank_csv_import_atomic_contract.sql.
