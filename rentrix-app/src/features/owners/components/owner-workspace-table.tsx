...
import { getOwnerDisplayLabel, getOwnerPropertyOwnershipLabel, type OwnerWorkspaceRow } from '../utils/owner-ui-helpers';
 ...
 */
export function OwnerWorkspaceTable({ rows, search, selectedOwner, onCreateOwner, onEditOwner, onSearchChange, onSelectOwner }: OwnerWorkspaceTableProps) {
