...
• توصية اليوم: مراجعة تقرير أعمار الديون في مركز التقارير وتجهيز معاينة تذكير آمنة بعد التحقق من الموافقة.`;
            ...
            <CardContent className="space-y-4">
              <div className="max-h-[32rem] space-y-3 overflow-y-auto rounded-2xl border bg-muted/20 p-3" aria-live="polite">
                <div className="me-auto max-w-[90%] rounded-2xl border bg-card px-4 py-3 text-sm leading-7 shadow-sm">
                  <p className="whitespace-pre-wrap">أهلاً بك في مساعد MALEK. اسألني عن المتأخرات، التجديدات القادمة، أو لقطة مالية سريعة — أقرأ بياناتك بأمان ولا أنفذ أي تعديل.</p>
                </div>
