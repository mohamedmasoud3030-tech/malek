...
export function OverviewSection({
  ...
  // Occupancy semantics are consumed, not decided here: occupied/vacant come
  // from the canonical occupancy rows and are aggregated without
  // reinterpretation, so the leasing workspace stays the single authority.
