...
// Lazy-loaded workspaces — code-split by feature
...
/**
 * Unified Finance Page — replaces both finance-hub/money-page.tsx and financials/financials-page.tsx
 *
 * Single authoritative entry point for all operational finance workflows:
 * - Collections (invoices, receipts, arrears)
 * - Expenses & Payables
 * - Fees (fixed monthly accruals)
 * - Funds (deposits, owner settlements)
 * - Banking (reconciliation)
 *
 * Uses ONE navigation layer (sidebar on desktop, WorkspaceNav on mobile)
 * with lazy-loaded workspaces behind Suspense boundaries.
 */
export function FinancePage() {
  ...
  // Permitted views & sections for the current user
  ...
  return (
    <PageLayout dir="rtl" lang="ar" size="wide" visualVariant="malek-pro">
      <div data-finance-root className="space-y-5">
        <PageHeader title="المالية" description="المستحقات والتحصيل والمصروفات والعمولات وأموال الملاك والبنوك في مساحة عمل واحدة." />
