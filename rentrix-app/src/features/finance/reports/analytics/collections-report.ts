/**
 * Finance Operational Reports — Collections Report
 *
 * Operational collection reports (invoices, payments, expenses summaries).
 * NOT accounting statements — those live in accounting/reports/.
 */

import { supabase } from '@/lib/supabase';
import type { FinancialReportFilters, PropertyContext } from '@/features/financials/reports/financial-report-rows';
import { loadPropertiesById, uniqueStrings } from '@/features/financials/reports/financial-report-rows';
import type {
...
} from '@/features/financials/reports/financial-reporting/report-calculations';
import { loadExpenses, loadInvoices, loadPayments } from '@/features/financials/reports/financial-reporting/report-loaders';
