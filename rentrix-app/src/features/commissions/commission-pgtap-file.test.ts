/**
 * Runs supabase/tests/commission_payment_lifecycle.sql against a full PGlite
...
describe('Commission payment lifecycle pgTAP contract', () => {
  it('runs supabase/tests/commission_payment_lifecycle.sql with zero failures', async () => {
    ...
    const stmts = splitStatements(transformSuite(readFileSync(join(repoRoot, 'supabase', 'tests', 'commission_payment_lifecycle.sql'), 'utf8')));
