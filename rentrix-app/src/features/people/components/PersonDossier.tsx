...
export function PersonDossierContent({
  ...
  const dossierQuery = usePersonDossier(
    personId,
    canViewFinancial,
    canViewActivity,
  );
  ...
  return (
    <div className="space-y-5">
          ...
          <header className="flex items-center gap-3 border-b border-border/60 pb-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-muted-foreground">
                البيانات الأساسية والعلاقة التعاقدية.
              </p>
            </div>
          </header>
          <DetailFields
            ...
            fields={[
              ...
              {
                label: 'العنوان',
                value: dossier.person.address ?? 'غير موثق',
                wide: true,
              },
              {
                label: 'ملاحظات',
                value: dossier.person.notes ?? '—',
                wide: true,
              },
            ]}
          />
        ...
        >
          ...
          {dossier.contracts.length === 0 ? (
            <p className="py-4 text-sm text-muted-foreground">
              لا توجد علاقات تعاقدية مسجلة لهذا الشخص.
            </p>
          ) : (
      ...
      {(!section || section === 'financials') && canViewFinancial ? (
        <section
          aria-labelledby="person-financial-heading"
          className={section ? undefined : 'border-t border-border/60 pt-4'}
        >
          <header className="border-b border-border/60 pb-2.5">
            <h3
              id="person-financial-heading"
              className="flex items-center gap-2 text-base font-black"
            >
            ...
            <div className="flex flex-wrap gap-2 border-t border-border/60 pt-3">
              ...
              <Button asChild variant="secondary" className="min-h-11">
                <Link
                  ...
                  search={
                    { view: 'arrears', tenantId: dossier.person.id } as never
                  }
                >
                  تحليل المتأخرات
                </Link>
      ...
      {(!section || section === 'records') && canViewActivity ? (
        <section
          aria-labelledby="person-activity-heading"
          className={section ? undefined : 'border-t border-border/60 pt-4'}
        >
          <header className="border-b border-border/60 pb-2.5">
            <h3
              id="person-activity-heading"
              className="flex items-center gap-2 text-base font-black"
            >
          ...
          {dossier.latestActivity.length === 0 ? (
            <p className="py-4 text-sm text-muted-foreground">
              لا يوجد نشاط موثّق مرتبط بهذا الشخص.
            </p>
          ) : (
            <ul className="divide-y divide-border/60">
...
export function PersonDetailPage({
  ...
  const personId =
    personIdProp ??
    (typeof params.personId === 'string' ? params.personId : '');
  ...
  return (
    <PageLayout dir="rtl" size="wide">
      ...
      <div
        ...
        role="tabpanel"
        aria-labelledby={`person-detail-tab-${activeSection}`}
      >
