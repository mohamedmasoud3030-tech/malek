              ...
              <div className="mt-5 space-y-5" data-support-panel>
                <div className="space-y-3">
                  <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-muted-foreground">
                    <span className="grid size-6 place-items-center rounded-full bg-support-brand/10 text-support-brand">
                  ...
                  <div className="grid gap-2.5">
                    {[SUPPORT_CONTACTS.oman, SUPPORT_CONTACTS.egypt, SUPPORT_CONTACTS.saudi].map((contact) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group flex items-center gap-3 rounded-xl border border-border/60 bg-card p-3 text-start shadow-sm transition-all hover:border-support-brand/30 hover:bg-support-brand/5 hover:shadow"
                      >
                        <span className="grid size-10 shrink-0 place-items-center rounded-full bg-support-brand/10 text-support-brand transition-colors group-hover:bg-support-brand group-hover:text-white">
                        ...
                        <ArrowLeft className="size-4 shrink-0 text-muted-foreground/50 transition-transform group-hover:-translate-x-0.5 group-hover:text-support-brand rtl:rotate-180" />
                      </a>
                    ))}
                  </div>
                </div>
