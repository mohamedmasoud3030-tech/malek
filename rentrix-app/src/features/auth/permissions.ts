...
export const permissionLabelsAr: Readonly<Record<AppPermission, string>> = {
  ...
  'properties.write': 'إضافة وتعديل العقارات والوحدات',
...
const rolePermissions = {
  ...
  MANAGER: new Set<AppPermission>([
    ...
    'maintenance.view', 'maintenance.write',
    'financial.workspace.view',
...
export const writeAccessPermissions = [
  'documents.write', 'service_providers.write', 'properties.write', 'contracts.write',
  'maintenance.write', 'expenses.write', 'financial.invoices.generate',
  'financial.payments.create', 'financial.receipts.void',
