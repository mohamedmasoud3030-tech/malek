...
const migration = readFileSync(
  resolve(import.meta.dirname, '../../../../supabase/migrations/20260901000049_granular_authority_patch_preflight.sql'),
  'utf8',
);

describe('granular RPC authority patch preflight', () => {
  it('runs before migration 00050 and refuses ambiguous legacy authority anchors', () => {
  ...
  it('covers every RPC that migration 00050 rewrites mechanically', () => {
