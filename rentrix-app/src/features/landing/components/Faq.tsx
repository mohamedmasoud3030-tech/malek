...
export function Faq() {
  ...
  return (
    <section id="faq" className="section-light bg-grid-light relative overflow-hidden border-t border-slate-200/70">
              ...
              <Reveal key={item.q} delay={i * 0.04}>
                <div
                  className={`overflow-hidden rounded-2xl border transition duration-300 ${
                    isOpen
                      ? 'border-brand-600/40 bg-white shadow-[0_18px_40px_-20px_rgba(37,84,235,0.35)]'
                ...
                >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen ? (
                      ...
                      >
                        <p className="px-5 pb-5 text-sm leading-8 text-slate-600 sm:px-6">
                          {item.a}
                        </p>
                      </motion.div>
                    ) : null}
