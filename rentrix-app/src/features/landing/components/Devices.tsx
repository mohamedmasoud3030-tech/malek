...
export function Devices() {
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      <div
        aria-hidden="true"
        className="absolute top-1/3 start-[-10%] size-[420px] rounded-full bg-primary/15 blur-[130px]"
      />
      <div
        aria-hidden="true"
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-[1fr_auto] lg:gap-8">
          <Reveal>
            <div className="relative max-w-2xl">
              ...
              <span className="absolute -top-4 end-4 z-10 inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/95 px-4 py-2 text-xs font-bold text-muted-foreground shadow-xl backdrop-blur">
            ...
            return (
              <Reveal key={bullet} delay={i * 0.08} className="h-full">
                <div className="glass-card flex h-full items-center gap-3 rounded-2xl p-5">
                  ...
                  <p className="text-sm font-bold leading-7 text-muted-foreground">{bullet}</p>
                </div>
              </Reveal>
            );
          })}
