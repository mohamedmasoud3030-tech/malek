...
export function CommandPaletteTrigger() {
  ...
  return (
    <button
      type="button"
      onClick={open}
      className="hidden md:flex items-center justify-between w-44 min-h-11 px-3 py-1.5 text-xs text-muted-foreground bg-muted/40 border border-border/70 rounded-xl hover:bg-muted/60 transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 cursor-pointer shadow-sm shrink-0 lg:w-60"
