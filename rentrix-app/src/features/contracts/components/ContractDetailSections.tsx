...
export function ContractOverviewSection({ contract, settings }: Readonly<{ contract: ContractDetail; settings: CompanySettingsContract }>) {
  ...
  const fields = [
    ...
    ...(contract.notes?.trim() ? [{ label: 'ملاحظات', value: contract.notes, wide: true }] : []),
  ];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>المعلومات المرجعية للعقد. الإجراءات والمستندات والمالية في تبويبات مستقلة.</CardDescription>
      </CardHeader>
