...
} from '@/features/financials/finance-shell-model';

const COMMISSIONS_PANEL_ID = 'money-commissions-panel';

/**
 * Task-centric Money composition root.
 *
 * Existing Finance workspaces remain authoritative. This hub only prevents
