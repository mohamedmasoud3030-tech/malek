...
const ownerSettlementsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/owner-settlements', beforeLoad: requirePermission('financial.owner_settlements.approve'), component: lazyRouteComponent(() => import('@/routes/_protected.owner-settlements'), 'OwnerSettlementsRouteComponent'), staticData: { title: 'تسويات الملاك' } });
