...
const commissionsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/commissions', beforeLoad: async () => { await requirePermission('commissions.view')(); throw redirect({ to: '/finance/banking', search: { section: 'commissions' } }); }, staticData: { title: 'العمولات' } });
const receiptsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/receipts', beforeLoad: () => { throw redirect({ to: '/finance/collections', search: { section: 'receipts' } }); }, staticData: { title: 'الإيصالات' } });
const expensesRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/expenses', beforeLoad: async () => { await requirePermission('expenses.view')(); throw redirect({ to: '/finance/expenses', search: { section: 'expenses' } }); }, staticData: { title: 'المصاريف' } });
const invoicesRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/invoices', beforeLoad: () => { throw redirect({ to: '/finance/collections', search: { section: 'invoices' } }); }, staticData: { title: 'الفواتير' } });
const arrearsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/arrears', beforeLoad: async () => { await requirePermission('arrears.view')(); throw redirect({ to: '/finance/expenses', search: { section: 'arrears' } }); }, staticData: { title: 'المتأخرات' } });
const bankReconciliationRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/bank-reconciliation', beforeLoad: async () => { await requirePermission('financial.bank_reconciliation.view')(); throw redirect({ to: '/finance/banking', search: { section: 'bank_reconciliation' } }); }, staticData: { title: 'مطابقة البنك' } });
const depositsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/deposits', beforeLoad: async () => { await requirePermission('financial.deposits.view')(); throw redirect({ to: '/finance/deposits', search: { section: 'deposits' } }); }, staticData: { title: 'التأمينات' } });
const ownerSettlementsRoute = createRoute({ getParentRoute: () => protectedRoute, path: '/owner-settlements', beforeLoad: async () => { await requirePermission('financial.owner_settlements.view')(); throw redirect({ to: '/finance/deposits', search: { section: 'owner_settlements' } }); }, staticData: { title: 'تسويات الملاك' } });
