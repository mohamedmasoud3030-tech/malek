...
export const ROUTE_CONTRACT: readonly RouteContractEntry[] = [
  ...
  { canonical: '/owners/$ownerId/edit', titleAr: 'تعديل مالك', sidebarRoot: '/people', isPrimaryNav: false, inMobileNav: false, permission: 'owners.detail.view', legacyAliases: [], viewBinding: null },
