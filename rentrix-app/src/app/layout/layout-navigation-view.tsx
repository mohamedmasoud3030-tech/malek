        ...
        {mobileNavItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span
                aria-hidden="true"
                className="absolute inset-x-1.5 inset-y-1 rounded-2xl bg-primary/0 transition-all duration-200 group-[.active]:bg-primary/[0.09] motion-reduce:transition-none"
              />
              {/* active top hairline */}
              <span
                aria-hidden="true"
                className="absolute inset-x-4 top-0 h-0.5 rounded-full bg-primary opacity-0 transition-all duration-200 group-[.active]:opacity-100 motion-reduce:transition-none"
              />
