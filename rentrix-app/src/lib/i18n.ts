...
const sharedTranslationEntries = [
  ...
  ['financialsPageDescription', 'فهرس شامل للعمليات المالية اليومية. اختر القسم الذي تريد إدارته — الفواتير، التحصيل، المصروفات، تسويات الملاك، وغيرها.', 'A complete index of day-to-day financial operations. Choose a workspace to manage invoices, collections, expenses, owner settlements, and more.'],
  ...
  ['reportsPageDescription', 'مركز تنفيذي لتحليل البيانات المالية. فلترة متقدمة، تصدير CSV، وعرض تفصيلي لكل تقرير محاسبي وتشغيلي.', 'An executive analytics center for financial data. Advanced filtering, CSV export, and detailed views for every accounting and operational report.'],
