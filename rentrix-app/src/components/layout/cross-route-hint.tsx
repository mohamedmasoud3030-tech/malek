  ...
  return (
    ...
    >
      ...
      {action ? (
        <Link
          to={action.to}
          className="inline-flex min-h-11 shrink-0 items-center self-start rounded-lg border border-primary/20 bg-background px-3 py-1.5 font-semibold text-primary transition hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary sm:self-auto"
        >
          {action.label}
        </Link>
      ) : null}
