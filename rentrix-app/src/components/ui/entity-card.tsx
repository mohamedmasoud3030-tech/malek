      ...
      <div className="flex min-w-0 items-start justify-between gap-2.5 sm:gap-3">
        <div className="flex min-w-0 flex-1 items-start gap-2.5 sm:gap-3">
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            ...
            {subtitle ? (
              <p className="mt-0.5 line-clamp-2 break-words text-xs font-medium leading-5 text-muted-foreground [overflow-wrap:anywhere]">
                {subtitle}
              </p>
            ) : null}
            {supportingText ? (
              <p className="mt-1 break-words text-xs font-semibold leading-5 text-muted-foreground [overflow-wrap:anywhere]">{supportingText}</p>
            ) : null}
          </div>
        </div>
        {badge ?? (
