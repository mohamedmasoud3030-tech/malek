...
describe('Phase 3A-1C forward / rollback / reapply', () => {
  beforeAll(async () => {
    const replay = await createFullReplayedDatabase({
      ...
      excludeMigrations: [MIGRATION_KEY, FOLLOW_UP_COMPATIBILITY_KEY, '20260804', '20260807163000', '20260817100000', 'phase1_omr_precision_convergence', 'phase2_invoice_truth', 'phase3_credit_and_ar_integrity'],
      writeEvidence: false,
    });
