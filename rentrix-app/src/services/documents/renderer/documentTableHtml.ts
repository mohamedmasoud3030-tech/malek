...
const columnAlignment = (rows: string[][], columnIndex: number): string =>
...
const headAlignment = (rows: string[][], columnIndex: number): string =>
...
const normalizeTotalsRows = (totals: string[] | string[][] | undefined): string[][] => {
